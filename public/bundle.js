...
if (windowQuery) {
	_node_modules_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from("#cursor", { ease: "linear", autoAlpha: 0, delay: 0.5 });
...

{
	...
	class Image {
		...
		resize() {
			// reset styles
			_node_modules_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(this.DOM.el, this.defaultStyle);
			// get sizes/position
			this.getRect();
		}
		getRect() {
		...
		isActive() {
			...
			return _node_modules_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.isTweening(this.DOM.el) || this.DOM.el.style.opacity != 0;
		}
	}
	...
	class ImageTrail {
		...
		showNextImage() {
			...
			let timeline = _node_modules_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();

			//for now
			let mqMatch = window.matchMedia("(min-width:980px)");
			if (mqMatch.matches) {
				if (hoverBanner) {
					_node_modules_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.killTweensOf(img.DOM.el);
					timeline = timeline
						// show the image
						.set(
							img.DOM.el,
